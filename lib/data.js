...
export const projectsData = [
  {
    ...
    description: (
      <span>
        ...
        <span className="font-semibold underline"> chee@gmail.com</span> and{" "}
...
export const educationData = [
  {
    ...
    description: (
      <span>
        ...
        >
          <FaEye /> see how I tracked my learning
        </Link>
      </span>
    ),
    year: "May-Nov 2024",
  ...
  },
  {
    ...
    description:
      "A field related to computer programming, computer architecture, data structure ",
