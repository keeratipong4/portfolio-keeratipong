...
export const projectsData = [
  {
    ...
    description:
      "This website is for internal employees of the hotel. You have to login with this made up email chee@gmail.com and password 12345 in order to manage bookings as if you are an employee of the hotel",
  ...
  },
  {
    ...
    tags: ["Vite", "React.js", "Redux", "Redux Toolkit", "Tailwind"],
    imageUrl: "/16-fast-react-pizza.png",
    repo: "https://github.com/keeratipong4/16-fast-react-pizza.git",
    liveDemo: "https://16-fast-react-pizza-z73mxvicn.vercel.app",
  },
  {
...
function WildOasisEmployeeContent() {
  return (
    <div className="bg-green-400" style={{ background: "#f472b6 " }}>
      ...
      <span className="pt-3 font-semibold text-green-400">chee@gmail.com</span>
